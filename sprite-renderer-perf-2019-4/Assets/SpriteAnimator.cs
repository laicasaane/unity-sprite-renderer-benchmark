...
public class SpriteAnimator : MonoBehaviour
{
    ...
    static readonly ProfilerMarker s_animateMarker = new ProfilerMarker(nameof(AnimateSpriteSystem));
    static readonly ProfilerMarker s_syncMarker = new ProfilerMarker(nameof(SyncSpriteSystem));
